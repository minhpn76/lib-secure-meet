 ...
 * for all globals of the projects in the Jitsi Meet family. If lib-secure-meet
...
export default _mergeNamespaceAndModule({
    ...
    */
     ...
     * user of lib-secure-meet that createLocalTracks is starting external
    ...
    /**
     * Informs lib-secure-meet about the current network status.
     *
     ...
     * interest to lib-secure-meet clients.
     */
    util: {
        AuthUtil,
        ScriptUtil,
