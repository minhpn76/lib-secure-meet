 ...
 * generic string, the convention used by lib-secure-meet and secure-meet is to
 ...
 * will be encapsulated in a format recognized by secure-meet and converted to
 * JSON before being sent.
 * @param {boolean} sendThroughVideobridge Whether to send the message through
 * secure-videobridge (via the COLIBRI data channel or web socket), or through
 * the XMPP MUC. Currently only objects can be sent through secure-videobridge.
 */
 ...
 * NOTE: method is used by the secure-meet-torture tests.
