...
function getConstraints(um, options = {}) {
    ...
    // @see https://github.com/jitsi/lib-secure-meet/pull/136
...
function onMediaDevicesListChanged(devicesReceived) {
    ...
    // Used by tracks to update the real device id before the consumer of lib-secure-meet receives the new device list.
