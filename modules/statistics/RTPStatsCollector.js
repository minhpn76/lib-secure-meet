...
/**
 * The lib-secure-meet browser-agnostic names of the browser-specific keys
...
export default function StatsCollector(
     ...
     * report returned by RTCPeerConnection#getStats with a lib-secure-meet
 ...
 * associated with a lib-secure-meet browser-agnostic name.
 *
 * @param {Object.<string,string>} keys the map of LibJitsi browser-agnostic
 * names to RTCPeerConnection#getStats browser-specific keys
 */
StatsCollector.prototype._defineGetStatValueMethod = function(keys) {
    // Define the function which converts a lib-secure-meet browser-asnostic name
    ...
    // associated with a specific lib-secure-meet browser-agnostic name.
 ...
 * Defines a function which (1) is to be used as a StatsCollector method and (2)
 * gets the value from a specific report returned by RTCPeerConnection#getStats
 * associated with a lib-secure-meet browser-agnostic name in case of using
